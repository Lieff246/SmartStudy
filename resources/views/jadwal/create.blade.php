<x-layouts.app>
    ...
    <div class="max-w-3xl">
        <div class="mb-6">
            ...
            <p class="text-gray-500 mt-1">Tambah jadwal untuk mata kuliah <strong>{{ $mataKuliah->nama_mk }}</strong>.</p>
        </div>

        <div class="bg-white rounded-3xl p-8 shadow-sm border border-gray-200">
            <form action="{{ route('mata-kuliah.jadwal.store', $mataKuliah) }}" method="POST" class="space-y-6">
                @csrf
