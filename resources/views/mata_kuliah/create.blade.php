<x-layouts.app>
    ...
    <div class="max-w-3xl">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Tambah Mata Kuliah</h1>
            <p class="text-gray-500 mt-1">Isi informasi mata kuliah untuk mendukung tugas dan jadwal.</p>
        </div>
